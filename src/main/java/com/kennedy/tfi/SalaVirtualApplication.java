...
public class SalaVirtualApplication {
	...
	public CommandLineRunner initData(UserRepository userRepository, MedicalDoctorRepository medicalDoctorRepository,
		...
		return (args) -> {
			...
			// Appointment
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 0), false, LocalTime.of(9, 15),
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 15), false, LocalTime.of(9, 30),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 30), false, LocalTime.of(9, 45),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 45), false, LocalTime.of(10, 0),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(14, 0), false,
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(16, 0), false,
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(16, 45), false,
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 30), false,
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 45), false,
