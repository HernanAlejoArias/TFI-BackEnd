...
public class SalaVirtualApplication {
	...
	public CommandLineRunner initData(UserRepository userRepository, MedicalDoctorRepository medicalDoctorRepository,
		...
		return (args) -> {
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(9, 0), false, LocalTime.of(9, 15),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Beatriz", "Leguizamon", LocalDate.of(1955, 6, 25), 9215788, 2, "Lanus", true,
					false, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 20), false, LocalTime.of(9, 35),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(9, 15), false, LocalTime.of(9, 30),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Cristian", "Vallarino", LocalDate.of(1983, 2, 22), 30127532, 1, "Banfield", true,
					false, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(9, 35), false, LocalTime.of(10, 0),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(9, 30), false, LocalTime.of(9, 45),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(9, 45), false, LocalTime.of(10, 0),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(10, 0), true, LocalTime.of(10, 15),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(10, 15), false,
					LocalTime.of(10, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Francisco", "De Marco", LocalDate.of(1978, 9, 10), 25725839, 1, "CABA", true,
					true, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(10, 50), false,
					LocalTime.of(11, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(10, 30), false,
					LocalTime.of(10, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(10, 45), false,
					LocalTime.of(11, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(11, 0), false,
					LocalTime.of(11, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Luciano", "Lunga", LocalDate.of(1981, 11, 11), 22987456, 1, "Lomas", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(11, 35), false,
					LocalTime.of(11, 40), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(11, 15), true,
					LocalTime.of(11, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Alejo", "Perez", LocalDate.of(1982, 2, 15), 29851753, 1, "Temperley", false,
					false, false, true, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(11, 40), false,
					LocalTime.of(12, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(11, 30), false,
					LocalTime.of(11, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(11, 45), true, LocalTime.of(12, 0),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(12, 0), false,
					LocalTime.of(12, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Laura", "Bonilla", LocalDate.of(1984, 5, 15), 33153323, 2, "Lanus", false, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(12, 35), false,
					LocalTime.of(12, 55), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(12, 15), false,
					LocalTime.of(12, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Andrea", "Gonzales", LocalDate.of(1982, 2, 27), 29445256, 2, "Temperlay", true,
					true, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(12, 55), false,
					LocalTime.of(13, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(12, 30), false,
					LocalTime.of(12, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(12, 45), false,
					LocalTime.of(13, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(13, 0), false,
					LocalTime.of(13, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(13, 15), true,
					LocalTime.of(13, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Camila", "Ensilla", LocalDate.of(1990, 10, 2), 37091840, 2, "Lomas", false,
					false, true, false, true);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(14, 5), false,
					LocalTime.of(14, 20), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(13, 30), true,
					LocalTime.of(13, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Roberto", "Burgos", LocalDate.of(1982, 7, 7), 290911112, 1, "CABA", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(14, 20), false,
					LocalTime.of(14, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(13, 45), false,
					LocalTime.of(14, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(14, 45), false,
					LocalTime.of(15, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(14, 0), false,
					LocalTime.of(14, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("German", "Castro", LocalDate.of(1967, 1, 28), 18888881, 1, "Lomas", true, true,
					true, true, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(15, 0), false,
					LocalTime.of(15, 20), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(14, 15), false,
					LocalTime.of(14, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(14, 30), true,
					LocalTime.of(14, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(14, 45), false,
					LocalTime.of(15, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(15, 0), false,
					LocalTime.of(15, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(15, 15), false,
					LocalTime.of(15, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			...
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(15, 30), false,
					LocalTime.of(15, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Natalia", "Damele", LocalDate.of(1990, 1, 13), 40192827, 1, "Lanus", false,
					false, false, true, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(16, 30), false,
					LocalTime.of(16, 50), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(15, 45), false,
					LocalTime.of(16, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Eliana", "Matera", LocalDate.of(1994, 11, 19), 45029126, 1, "CABA", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(16, 50), false,
					LocalTime.of(17, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(16, 0), true, LocalTime.of(16, 15),
					tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Florencia", "Persiani", LocalDate.of(1986, 9, 20), 33245927, 2, "Lomas", true,
					false, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 0), false,
					LocalTime.of(17, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(16, 15), false,
					LocalTime.of(16, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Florencia", "De Lucca", LocalDate.of(1991, 5, 12), 37726189, 2, "Lanus", false,
					false, false, true, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 15), false,
					LocalTime.of(17, 25), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(16, 30), false,
					LocalTime.of(16, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Norma", "Ponce", LocalDate.of(1968, 5, 4), 13916645, 1, "CABA", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 25), false,
					LocalTime.of(17, 40), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(16, 45), false,
					LocalTime.of(17, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Florencia", "Salamanca", LocalDate.of(1995, 6, 13), 46782722, 2, "Lanus", true,
					false, false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 40), false,
					LocalTime.of(17, 55), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(17, 0), false,
					LocalTime.of(17, 15), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Vanesa", "Apodaca", LocalDate.of(1982, 5, 14), 29786687, 2, "Lanus", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(17, 55), false,
					LocalTime.of(18, 10), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(17, 15), false,
					LocalTime.of(17, 30), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Gabriel", "Perez", LocalDate.of(1988, 3, 27), 35781115, 1, "Lanus", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(18, 10), false,
					LocalTime.of(18, 25), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(17, 30), false,
					LocalTime.of(17, 45), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempPatient = new Patient("Gonzalo", "Marcec", LocalDate.of(1984, 7, 10), 31766985, 1, "Lanus", true, false,
					false, false, false);
			patientRepository.save(tempPatient);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 1), LocalTime.of(18, 25), false,
					LocalTime.of(18, 40), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
			tempAppointment = new Appointment(LocalDate.of(2021, 6, 2), LocalTime.of(17, 45), false,
					LocalTime.of(18, 0), tempClinica, tempPatient, true, false);
			appointmentRepository.save(tempAppointment);
